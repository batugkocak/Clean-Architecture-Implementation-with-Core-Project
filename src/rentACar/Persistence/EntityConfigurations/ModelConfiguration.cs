...
public class ModelConfiguration : IEntityTypeConfiguration<Model>
{
    public void Configure(EntityTypeBuilder<Model> builder)
    {
        ...
        builder.Property(m => m.CreatedAt).HasColumnName("CreatedDate").IsRequired();
        builder.Property(m => m.UpdatedAt).HasColumnName("UpdatedDate");
        builder.Property(m => m.DeletedAt).HasColumnName("DeletedDate");
