...
public class EmailAuthenticatorConfiguration : IEntityTypeConfiguration<EmailAuthenticator>
{
    public void Configure(EntityTypeBuilder<EmailAuthenticator> builder)
    {
        ...
        builder.Property(ea => ea.CreatedAt).HasColumnName("CreatedDate").IsRequired();
        builder.Property(ea => ea.UpdatedAt).HasColumnName("UpdatedDate");
        builder.Property(ea => ea.DeletedAt).HasColumnName("DeletedDate");
