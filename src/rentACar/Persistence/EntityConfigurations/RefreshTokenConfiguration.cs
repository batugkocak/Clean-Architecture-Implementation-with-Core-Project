...
public class RefreshTokenConfiguration : IEntityTypeConfiguration<RefreshToken>
{
    public void Configure(EntityTypeBuilder<RefreshToken> builder)
    {
        ...
        builder.Property(rt => rt.CreatedAt).HasColumnName("CreatedDate").IsRequired();
        builder.Property(rt => rt.UpdatedAt).HasColumnName("UpdatedDate");
        builder.Property(rt => rt.DeletedAt).HasColumnName("DeletedDate");
