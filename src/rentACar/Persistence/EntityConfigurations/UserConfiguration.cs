...
public class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder.Property(u => u.CreatedAt).HasColumnName("CreatedDate").IsRequired();
        builder.Property(u => u.UpdatedAt).HasColumnName("UpdatedDate");
        builder.Property(u => u.DeletedAt).HasColumnName("DeletedDate");
