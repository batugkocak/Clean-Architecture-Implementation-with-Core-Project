...
public class FuelConfiguration : IEntityTypeConfiguration<Fuel>
{
    public void Configure(EntityTypeBuilder<Fuel> builder)
    {
        ...
        builder.Property(f => f.CreatedAt).HasColumnName("CreatedDate").IsRequired();
        builder.Property(f => f.UpdatedAt).HasColumnName("UpdatedDate");
        builder.Property(f => f.DeletedAt).HasColumnName("DeletedDate");
